# finnhub-analyst-data Specification

## Purpose
Define requirements for fetching analyst recommendation data, company/ETF profile data, and historical candle data from Finnhub and Yahoo Finance, including caching behaviour.
